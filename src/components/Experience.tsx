...
const experiences = [
  {
    ...
    description: "Implemented and maintained secure backend APIs with Keycloak auth, gRPC integrations, RBAC, and OpenAPI specs across onboarding, payments, templates, approvals, and transactions. Resolved critical system stability issues including gRPC failures, race conditions, webhook errors, and intermittent 500s. Delivered scalable features such as invite-member workflows, approval rules, exports, cron jobs, metadata-driven validation, and cascading deletes.",
  ...
  },
  {
    ...
    description: "Optimized legacy code to reduce database locks from multithreaded access, improving throughput by 84.6%. Updated query conditions reducing response time by 62.5%. Built a PoC centralized log-monitoring solution using Elasticsearch, Kibana, and Filebeat. Updated 300+ SoapUI test suites. Upgraded multithreaded file-scanning performance by up to 93%, eliminating I/O alarms. Optimized loggers to reduce storage by 90%. Designed a Java-based CDR load simulator for production-scale testing.",
  ...
  },
  {
    ...
    description: "Graduated with 8.73/10.0 CGPA. Focused on software engineering, data structures, algorithms, and neural networks. Completed ISRO satellite image classification project during final year.",
